...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_GimpactTestDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_GimpactTestDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_GimpactTestDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_GimpactTestDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/GimpactTestDemo.o \
	$(OBJDIR)/Win32GimpactDemo.o \
	$(OBJDIR)/main.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_GimpactTestDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_GimpactTestDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/GimpactTestDemo.o: ../../Demos/GimpactTestDemo/GimpactTestDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32GimpactDemo.o: ../../Demos/GimpactTestDemo/Win32GimpactDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/main.o: ../../Demos/GimpactTestDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
