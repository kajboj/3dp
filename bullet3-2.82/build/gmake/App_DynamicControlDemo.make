...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_DynamicControlDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_DynamicControlDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/DynamicControlDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/MotorDemo.o: ../../Demos/DynamicControlDemo/MotorDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
