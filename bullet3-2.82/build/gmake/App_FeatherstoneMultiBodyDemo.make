...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_FeatherstoneMultiBodyDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_FeatherstoneMultiBodyDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_FeatherstoneMultiBodyDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_FeatherstoneMultiBodyDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/main.o \
	$(OBJDIR)/Win32FeatherstoneMultiBodyDemo.o \
	$(OBJDIR)/FeatherstoneMultiBodyDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_FeatherstoneMultiBodyDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_FeatherstoneMultiBodyDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../Demos/FeatherstoneMultiBodyDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32FeatherstoneMultiBodyDemo.o: ../../Demos/FeatherstoneMultiBodyDemo/Win32FeatherstoneMultiBodyDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/FeatherstoneMultiBodyDemo.o: ../../Demos/FeatherstoneMultiBodyDemo/FeatherstoneMultiBodyDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
