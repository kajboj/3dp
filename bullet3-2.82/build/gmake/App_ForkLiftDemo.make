...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_ForkLiftDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ForkLiftDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_ForkLiftDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ForkLiftDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
clean:
	@echo Cleaning App_ForkLiftDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../Demos/ForkLiftDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/ForkLiftDemo.o: ../../Demos/ForkLiftDemo/ForkLiftDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
