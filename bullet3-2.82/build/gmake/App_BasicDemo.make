...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_BasicDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_BasicDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_BasicDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_BasicDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/BasicDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32BasicDemo.o: ../../Demos/BasicDemo/Win32BasicDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/BasicDemo.o: ../../Demos/BasicDemo/BasicDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
