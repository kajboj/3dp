...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_Box2dDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_Box2dDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_Box2dDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_Box2dDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/Box2dDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32Box2dDemo.o: ../../Demos/Box2dDemo/Win32Box2dDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Box2dDemo.o: ../../Demos/Box2dDemo/Box2dDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
