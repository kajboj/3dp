...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_ContinuousConvexCollision
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ContinuousConvexCollision_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_ContinuousConvexCollision
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ContinuousConvexCollision_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/ContinuousConvexCollisionDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_ContinuousConvexCollision
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_ContinuousConvexCollision
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/ContinuousConvexCollisionDemo.o: ../../Demos/ContinuousConvexCollision/ContinuousConvexCollisionDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
