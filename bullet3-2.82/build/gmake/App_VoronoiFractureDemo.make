...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_VoronoiFractureDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_VoronoiFractureDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_VoronoiFractureDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_VoronoiFractureDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	...
	$(OBJDIR)/main.o \
	$(OBJDIR)/Win32VoronoiFractureDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_VoronoiFractureDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_VoronoiFractureDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/VoronoiFractureDemo.o: ../../Demos/VoronoiFractureDemo/VoronoiFractureDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/main.o: ../../Demos/VoronoiFractureDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32VoronoiFractureDemo.o: ../../Demos/VoronoiFractureDemo/Win32VoronoiFractureDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
