...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_SimplexDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_SimplexDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_SimplexDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_SimplexDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/SimplexDemo.o: ../../Demos/SimplexDemo/SimplexDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
