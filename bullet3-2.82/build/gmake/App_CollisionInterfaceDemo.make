...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_CollisionInterfaceDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_CollisionInterfaceDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_CollisionInterfaceDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_CollisionInterfaceDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/Win32CollisionInterfaceDemo.o \
	$(OBJDIR)/main.o \
	$(OBJDIR)/CollisionInterfaceDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_CollisionInterfaceDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_CollisionInterfaceDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/Win32CollisionInterfaceDemo.o: ../../Demos/CollisionInterfaceDemo/Win32CollisionInterfaceDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/main.o: ../../Demos/CollisionInterfaceDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/CollisionInterfaceDemo.o: ../../Demos/CollisionInterfaceDemo/CollisionInterfaceDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
