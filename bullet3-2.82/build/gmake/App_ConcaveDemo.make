...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_ConcaveDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ConcaveDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_ConcaveDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ConcaveDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/Win32ConcaveDemo.o \
	$(OBJDIR)/main.o \
	$(OBJDIR)/ConcavePhysicsDemo.o \
...
$(OBJDIR)/Win32ConcaveDemo.o: ../../Demos/ConcaveDemo/Win32ConcaveDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/main.o: ../../Demos/ConcaveDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/ConcavePhysicsDemo.o: ../../Demos/ConcaveDemo/ConcavePhysicsDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
