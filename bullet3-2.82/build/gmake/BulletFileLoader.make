...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/BulletFileLoader
  TARGETDIR  = ../../Extras/lib
  TARGET     = $(TARGETDIR)/libBulletFileLoader_gmake.a
  DEFINES   += 
  INCLUDES  += -I../../src
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/BulletFileLoader
  TARGETDIR  = ../../Extras/lib
  TARGET     = $(TARGETDIR)/libBulletFileLoader_gmake_debug.a
  DEFINES   += 
  INCLUDES  += -I../../src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
