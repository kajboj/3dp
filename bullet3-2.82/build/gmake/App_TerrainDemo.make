...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_TerrainDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_TerrainDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_TerrainDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_TerrainDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/TerrainDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/TerrainDemo.o: ../../Demos/TerrainDemo/TerrainDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
