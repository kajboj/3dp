...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_InternalEdgeDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_InternalEdgeDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_InternalEdgeDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_InternalEdgeDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/main.o \
	$(OBJDIR)/Win32InternalEdgeDemo.o \
	$(OBJDIR)/InternalEdgeDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_InternalEdgeDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_InternalEdgeDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../Demos/InternalEdgeDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32InternalEdgeDemo.o: ../../Demos/InternalEdgeDemo/Win32InternalEdgeDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/InternalEdgeDemo.o: ../../Demos/InternalEdgeDemo/InternalEdgeDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
