...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_MovingConcaveDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_MovingConcaveDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_MovingConcaveDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_MovingConcaveDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_MovingConcaveDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_MovingConcaveDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/ConcavePhysicsDemo.o: ../../Demos/MovingConcaveDemo/ConcavePhysicsDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
