...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_ConcaveConvexcastDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ConcaveConvexcastDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_ConcaveConvexcastDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ConcaveConvexcastDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/main.o \
	$(OBJDIR)/ConcaveConvexcastDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_ConcaveConvexcastDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_ConcaveConvexcastDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../Demos/ConcaveConvexcastDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/ConcaveConvexcastDemo.o: ../../Demos/ConcaveConvexcastDemo/ConcaveConvexcastDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
