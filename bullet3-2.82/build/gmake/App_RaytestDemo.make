...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_RaytestDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_RaytestDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_RaytestDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_RaytestDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/RaytestDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32RaytestDemo.o: ../../Demos/RaytestDemo/Win32RaytestDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/RaytestDemo.o: ../../Demos/RaytestDemo/RaytestDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
