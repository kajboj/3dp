...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_GyroscopicDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_GyroscopicDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_GyroscopicDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_GyroscopicDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/main.o \
	$(OBJDIR)/GyroscopicDemo.o \
	$(OBJDIR)/Win32GyroscopicDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_GyroscopicDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_GyroscopicDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../Demos/GyroscopicDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/GyroscopicDemo.o: ../../Demos/GyroscopicDemo/GyroscopicDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32GyroscopicDemo.o: ../../Demos/GyroscopicDemo/Win32GyroscopicDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
