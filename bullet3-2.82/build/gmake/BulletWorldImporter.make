...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/BulletWorldImporter
  TARGETDIR  = ../../Extras/lib
  TARGET     = $(TARGETDIR)/libBulletWorldImporter_gmake.a
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/BulletWorldImporter
  TARGETDIR  = ../../Extras/lib
  TARGET     = $(TARGETDIR)/libBulletWorldImporter_gmake_debug.a
  DEFINES   += 
  INCLUDES  += -I../../Extras/Serialize/BulletFileLoader -I../../src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
