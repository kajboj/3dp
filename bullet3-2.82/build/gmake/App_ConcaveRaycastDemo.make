...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_ConcaveRaycastDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ConcaveRaycastDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_ConcaveRaycastDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_ConcaveRaycastDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_ConcaveRaycastDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_ConcaveRaycastDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/ConcaveRaycastDemo.o: ../../Demos/ConcaveRaycastDemo/ConcaveRaycastDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/main.o: ../../Demos/ConcaveRaycastDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
