...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_VehicleDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_VehicleDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/VehicleDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/heightfield128x128.o: ../../Demos/VehicleDemo/heightfield128x128.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/VehicleDemo.o: ../../Demos/VehicleDemo/VehicleDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
