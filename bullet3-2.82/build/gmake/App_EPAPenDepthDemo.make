...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_EPAPenDepthDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_EPAPenDepthDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_EPAPenDepthDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_EPAPenDepthDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/PenetrationTestBullet.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_EPAPenDepthDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_EPAPenDepthDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/PenetrationTestBullet.o: ../../Demos/EPAPenDepthDemo/PenetrationTestBullet.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
