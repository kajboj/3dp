...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_RagdollDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_RagdollDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_RagdollDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_RagdollDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
$(OBJDIR)/main.o: ../../Demos/RagdollDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/RagdollDemo.o: ../../Demos/RagdollDemo/RagdollDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
