...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_RollingFrictionDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_RollingFrictionDemo_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_RollingFrictionDemo
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_RollingFrictionDemo_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/main.o \
	$(OBJDIR)/Win32RollingFrictionDemo.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_RollingFrictionDemo
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_RollingFrictionDemo
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/main.o: ../../Demos/RollingFrictionDemo/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/Win32RollingFrictionDemo.o: ../../Demos/RollingFrictionDemo/Win32RollingFrictionDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
$(OBJDIR)/RollingFrictionDemo.o: ../../Demos/RollingFrictionDemo/RollingFrictionDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
