...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/App_UserCollisionAlgorithm
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_UserCollisionAlgorithm_gmake
  DEFINES   += 
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/App_UserCollisionAlgorithm
  TARGETDIR  = ../..
  TARGET     = $(TARGETDIR)/App_UserCollisionAlgorithm_gmake_debug
  DEFINES   += 
  INCLUDES  += -I../../src -I../../Demos/OpenGL
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
OBJECTS := \
	$(OBJDIR)/UserCollisionAlgorithm.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking App_UserCollisionAlgorithm
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning App_UserCollisionAlgorithm
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/UserCollisionAlgorithm.o: ../../Demos/UserCollisionAlgorithm/UserCollisionAlgorithm.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -MF $(@:%.o=%.d) -c "$<"
